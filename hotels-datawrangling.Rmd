...
try out.
<chr>hotel, arrival_date_month, meal, country, market_segment, distribution
...
We are more ikely to find bookings with children or babies at city hotels.
Bookings at resort hotels with children or babies: 3,929
Bookings at city hotels with children or babies: 5,403
...
The most common number of adults is 2. This is somewhat surprising, because I would expect that people travelling solo would outnumber pairs. Another surprising result is the number of zeros ("0"). 
...
Pairs of 2 were the most likely to cancel, and not to cancel.
Also, it is surprising that so many bookings were canceled period (44K), compared with not canceled (75K).
